...
class Set {
    ...
    private void displaySetScore(DisplayInformation displayInformation) {
    ...
    private void incrementSetScorePlayer(Player player) {
    ...
    private void activateTieBreak(Player player) {
        ...
        if ((player1.getUsername().equals(gameWinner) && setScorePlayer1 >= 7 && (tieBreakScorePlayer1 >= (tieBreakScorePlayer2 + 2)))
